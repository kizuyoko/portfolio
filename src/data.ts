...
const projects: ProjectType[] = [
  {
    ...
    title:'PokeCheck',
    image: 'pokecheck.png',
    description: "PokeCheck is a responsive Pokémon matchup checker that allows users to search for Pokémon and explore type effectiveness. Built with TypeScript and Next.js, the app emphasizes speed, accessibility, and user experience. It fetches real-time data from the official PokéAPI using TanStack Query and Axios. The project includes Jest for unit testing, Storybook for UI documentation, and has been performance-audited with Lighthouse, achieving top scores on both desktop and mobile.",
    stack: ['Next.js', 'TypeScript', 'Jest', 'React', 'LightHouse', 'TanStack Query', 'Axios', 'Tailwind', 'Storybook', 'Vercel', 'PokéAPI'],
